...
--
-- Table structure for table `info_kota_2`
--

DROP TABLE IF EXISTS `info_kota_2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `info_kota_2` (
  `kota` char(20) NOT NULL,
  `jml_penduduk` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`kota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `info_kota_2`
--

LOCK TABLES `info_kota_2` WRITE;
/*!40000 ALTER TABLE `info_kota_2` DISABLE KEYS */;
INSERT INTO `info_kota_2` VALUES ('Bandung',2339463),('Bekasi',2381053),('Depok',1631951),('Jakarta',9988495),('Makassar',1651146),('Medan',2465469),('Palembang',1548064),('Semarang',1621374),('Surabaya',2805906),('Tangerang',1566190);
/*!40000 ALTER TABLE `info_kota_2` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-07-05 15:01:40
